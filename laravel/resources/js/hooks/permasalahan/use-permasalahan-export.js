...
export const usePermasalahanExport = (kelas, jurusan, tahun) => {
    ...
    const handleExport = async (format) => {
        ...
        const url = `/permasalahan/${kelas}/${jurusan}/${tahun}/export/${format}`;
        ...
        try {
            ...
            if (contentType && contentType.includes("application/json")) {
                ...
                a.download = filenameMatch
                    ? filenameMatch[1]
                    : `Laporan-Permasalahan-${kelas}-${jurusan}-${tahun}.${
