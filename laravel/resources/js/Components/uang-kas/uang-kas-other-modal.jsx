...
import { useUangKasOtherForm } from "@/hooks/uang-kas/use-uang-kas-other-form";

const UangKasOtherModal = ({
    isOpen,
    onClose,
    selectedClass,
    onSuccess,
                            ...
                            <div className="p-4 md:p-6 flex flex-col space-y-4 md:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Misalnya: Iuran Studi Tur, Beli Buku LKS"
                                        className={`mt-1 w-full px-3 py-2 rounded-xl border focus:outline-none placeholder:text-sm ${
                                            errors.deskripsi
                                                ? "border-red-500"
                                                : "border-slate-300 focus:border-sky-500"
...
export default UangKasOtherModal;
