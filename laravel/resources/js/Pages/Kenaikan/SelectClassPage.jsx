...
import { useKenaikanClasses } from "@/hooks/kenaikan/use-kenaikan-classes";

const SelectClassPage = () => {
    const { classes, isLoading, error } = useKenaikanClasses();
    ...
    return (
        <PageContent breadcrumbItems={breadcrumbItems} pageClassName="-mt-20">
            <h3 className="text-md md:text-lg font-medium text-neutral-700 mb-4 md:mb-6">
                Pilih Kelas Untuk Kenaikan Bersyarat
            </h3>
